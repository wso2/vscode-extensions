    ...
    for (const port of Object.values(ports)) {
        if (port instanceof InputOutputPortModel) {
            ...
            if (link instanceof DataMapperLinkModel) {
                ...
                if (sourceNode instanceof LinkConnectorNode || sourceNode instanceof QueryExprConnectorNode || sourceNode instanceof ClauseConnectorNode || sourceNode instanceof BinaryConnectorNode) {
