...
export class PlatformExtRpcManager implements PlatformExtAPI {
    ...
    async startProxyServer(
        ...
        try {
            ...
            log(`Not connecting to WSO2 Cloud as the necessary conditions are not met. DebugConfig: ${JSON.stringify(debugConfig)}, Store State: ${JSON.stringify(platformExtStore.getState().state)}`);
