...
export class WebExtendedLanguageClient extends LanguageClient implements ExtendedLangClientInterface {
    ...
    async getDocumentSymbol(
        params: DocumentSymbolParams
    ): Promise<DocumentSymbol[] | SymbolInformation[] | NOT_SUPPORTED_TYPE> {
    ...
    async getConnectors(params: ConnectorsParams, reset?: boolean): Promise<Connectors | NOT_SUPPORTED_TYPE> {
        ...
        if (!reset && params.query === "" && !params.keyword && !params.organization && !params.offset) {
            ...
            const connectorList = this.ballerinaExtInstance?.context?.globalState.get(
    ...
    async getVisibleVariableTypes(
        params: VisibleVariableTypesParams
    ): Promise<VisibleVariableTypes | NOT_SUPPORTED_TYPE> {
        return this.sendRequest<VisibleVariableTypes>(EXTENDED_APIS.VISIBLE_VARIABLE_TYPES, params);
    }

    async getInlineDataMapperMappings(
        params: InlineDataMapperModelRequest
    ): Promise<InlineDataMapperModelResponse | NOT_SUPPORTED_TYPE> {
        return this.sendRequest<InlineDataMapperModelResponse>(EXTENDED_APIS.DATA_MAPPER_MAPPINGS, params);
    }

    async getInlineDataMapperSource(
        params: InlineDataMapperSourceRequest
    ): Promise<InlineDataMapperSourceResponse | NOT_SUPPORTED_TYPE> {
        return this.sendRequest<InlineDataMapperSourceResponse>(EXTENDED_APIS.DATA_MAPPER_GET_SOURCE, params);
    }

    async getVisualizableFields(
        params: VisualizableFieldsRequest
    ): Promise<VisualizableFieldsResponse | NOT_SUPPORTED_TYPE> {
        return this.sendRequest<VisualizableFieldsResponse>(EXTENDED_APIS.DATA_MAPPER_VISUALIZABLE, params);
    }

    async addArrayElement(
        params: AddArrayElementRequest
    ): Promise<InlineDataMapperSourceResponse | NOT_SUPPORTED_TYPE> {
    ...
    async getBallerinaProjectComponents(
        params: BallerinaPackagesParams
    ): Promise<BallerinaProjectComponents | NOT_SUPPORTED_TYPE> {
    ...
    async getBallerinaProjectConfigSchema(
        params: BallerinaProjectParams
    ): Promise<PackageConfigSchema | NOT_SUPPORTED_TYPE> {
    ...
    async getProjectDiagnostics(
        params: ProjectDiagnosticsRequest
    ): Promise<ProjectDiagnosticsResponse | NOT_SUPPORTED_TYPE> {
    ...
    async getMainFunctionParams(
        params: MainFunctionParamsRequest
    ): Promise<MainFunctionParamsResponse | NOT_SUPPORTED_TYPE> {
    ...
    async getRecordModelFromSource(params: GetRecordModelFromSourceRequest): Promise<GetRecordModelFromSourceResponse> {
        return this.sendRequest<GetRecordModelFromSourceResponse>(
            EXTENDED_APIS.BI_GET_RECORD_MODEL_FROM_SOURCE,
            params
        );
    }
    ...
    async registerExtendedAPICapabilities(): Promise<Set<String>> {
        ...
        await this.initBalServices({
            ballerinaClientCapabilities: [
                {
                    name: EXTENDED_APIS_ORG.DOCUMENT,
                    syntaxTreeNode: true,
                    executorPositions: true,
                    syntaxTreeModify: true,
                    diagnostics: true,
                    syntaxTree: true,
                    astModify: true,
                    triggerModify: true,
                ...
                {
                    name: EXTENDED_APIS_ORG.SYMBOL,
                    type: true,
                    getSymbol: true,
                    getTypeFromExpression: true,
                    getTypeFromSymbol: true,
                    getTypesFromFnDefinition: true,
                },
                {
                    name: EXTENDED_APIS_ORG.CONNECTOR,
                    connectors: true,
                    connector: true,
                    record: true,
                },
                {
                    name: EXTENDED_APIS_ORG.TRIGGER,
                    triggers: true,
                    trigger: true,
                },
                {
                    name: EXTENDED_APIS_ORG.RUNNER,
                    diagnostics: true,
                    mainFunctionParams: true,
                },
                ...
                {
                    name: EXTENDED_APIS_ORG.PARTIAL_PARSER,
                    getSTForSingleStatement: true,
                    getSTForExpression: true,
                    getSTForResource: true,
                },
                ...
                {
                    name: EXTENDED_APIS_ORG.NOTEBOOK_SUPPORT,
                    getResult: true,
                    getShellFileSource: true,
                    getVariableValues: true,
                    deleteDeclarations: true,
                    restartNotebook: true,
                },
            ],
        })
            .then((response) => {
