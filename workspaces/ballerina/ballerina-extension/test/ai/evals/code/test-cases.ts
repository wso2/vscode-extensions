...
export const testCasesForCodeIndexing = [
  ...
  // },
  // {
  //   prompt: "Change the Kafka publishing logic so that high-value orders are published to a separate configurable topic instead of the default order events topic.",
  //   projectPath: "simple_order_management_system"
  // },
  // {
  //   prompt: "Update when the user creates an order, the system should check if the customer has any pending orders and if so, it should reject the new order with a proper error message.",
