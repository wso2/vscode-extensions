...
import { deleteRegistryResource, deleteDataMapperResources , deleteSchemaResources, deleteSwaggerAndMetadata} from '../util/fileOperations';
			...
			case 'class-mediator':
				{
					...
					if (confirmation === 'Yes') {
						try {
							await vscode.workspace.fs.delete(Uri.file(fileUri.fsPath ?? fileUri), { recursive: true});
