        ...
        async (progress, token) => await new Promise<void>((resolve, reject) => {
            ...
            function buildModule() {
                ...
                const moduleGenCommand = isBallerinaInstalled 
                    ? (isWindows ? 'bal.bat mi-module-gen -i . -t target' : 'bal mi-module-gen -i . -t target')
                    : `${path.join(balHome, isWindows ? 'bal.bat' : 'bal')} mi-module-gen -i . -t target`;
                ...
                async function onComplete() {
                    try {
                        ...
                        const zipPath = path.join(projectPath, 'target', zipName);
                        ...
                        // Clean up the target folder if it exists
