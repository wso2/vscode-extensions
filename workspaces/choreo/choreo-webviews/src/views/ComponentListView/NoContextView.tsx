...
import {ICloneProjectCmdParams, ICmdParamsBase, ICreateComponentCmdParams, CommandIds as PlatformCommandIds} from '@wso2/wso2-platform-core'
	...
	return (
		<>
			...
			<div className="flex w-full flex-col gap-[10px] px-6 py-2">
				...
				<Button
					className="w-full max-w-80 self-center sm:self-start"
					onClick={() => ChoreoWebViewAPI.getInstance().triggerCmd(PlatformCommandIds.CreateDirectoryContext,{extName:"Choreo"} as ICmdParamsBase)}
				...
				<p>
					...
					<VSCodeLink onClick={() => ChoreoWebViewAPI.getInstance().triggerCmd(PlatformCommandIds.CloneProject, {extName:"Choreo"} as ICloneProjectCmdParams)}>here</VSCodeLink>.
				</p>
			</div>
		</>
	);
