...
export class ApiTryItRpcClient {
    ...
    sendMessage(message: string): Promise<string> {
        return this._messenger.sendRequest(sendMessage, HOST_EXTENSION, message);
    }
...
export function createApiTryItRpcClient(messenger: Messenger): ApiTryItRpcClient {
    return new ApiTryItRpcClient(messenger);
}
